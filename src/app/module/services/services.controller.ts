...
const getServicesById = catchAsync(async (req: Request, res: Response) => {
  const result = await servicesService.getServicesById(req.params.id as string);
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
...
const updateServices = catchAsync(async (req: Request, res: Response) => {
  const result = await servicesService.updateServices(
...
const deleteServices = catchAsync(async (req: Request, res: Response) => {
  const result = await servicesService.deleteServices(req.params.id as string);
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
